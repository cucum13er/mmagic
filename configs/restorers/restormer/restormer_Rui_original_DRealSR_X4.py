...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            gt_folder='data/DRealSR/Train_x4/train_LR',
   ...
   test=dict(
       type=train_dataset_type,
       gt_folder= 'data/DRealSR/Test_x4/test_LR',
...
load_from = None#'/work/pi_xiandu_umass_edu/ruima/pretrain/Restormer/restormer_Rui_pretrainFromOfficialColorBlind.pth'
resume_from = '/work/pi_xiandu_umass_edu/ruima/git/mmediting_Rui_git/work_dirs/restorers/restormer/X4/pretrain_DRealSR/latest.pth'
workflow = [('train', 1)]