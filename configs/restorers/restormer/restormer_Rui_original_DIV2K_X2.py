# model settings
exp_name = 'restormer_pretrain_DIV2K'
scale = 2
img_size = 48
# model settings
model = dict(
...
resume_from = '/work/pi_xiandu_umass_edu/ruima/git/mmediting_Rui_git/work_dirs/restorers/restormer/X2/pretrain_DIV2K/iter_900.pth'
workflow = [('train', 1)]