...
class Restormer_Rui(BaseModule):
    ...
    def __init__(self,
        ...
        super(Restormer_Rui, self).__init__()
    ...
    def forward(self, inp_img, contrastive_feat):
        ...
        # breakpoint()
        # if self.patch_embed.proj.weight.grad is not None:
        #     print(self.patch_embed.proj.weight.grad[40])
        # if True in torch.isnan(inp_enc_level1):
        #     breakpoint()        
        out_enc_level1 = self.encoder_level1(inp_enc_level1)
        # breakpoint()
        # if True in torch.isnan(out_enc_level1):
        #     breakpoint()          
        ...
        if self.dual_pixel_task:
            ...
            out_dec_level1 = self.output(out_dec_level1)
        # breakpoint()
        # if True in torch.isnan(out_dec_level1):
        #     breakpoint()
